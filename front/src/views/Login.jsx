...
export default function Login() {
  ...
  return (
    <div className="flex justify-center items-center h-screen">
      <div className="p-2 rounded-xl backdrop-filter shadow-lg ">
        <form onSubmit={SubmitHand} className=" ">
          {message && (
            <div className="alert">
              <p>{message}</p>
            </div>
          ...
          <div className="my-1 flex flex-col">
            ...
            <p>
              Reset password?
              <a className="text-sky-500  hover:text-slate-900" href="#">
                forget password
              </a>
            </p>
          </div>
      ...
      {/* my-3  bg-gray-50 p-3 rounded-lg opacity-90 absolute top-1/4 */}
