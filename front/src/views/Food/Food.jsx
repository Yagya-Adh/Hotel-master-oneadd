  ...
  return (
    <div className="flex-col justify-center">
      <div className="my-2 justify-end flex">
        <a
          href="/cart"
          className="border-slate-700 px-4 flex-rrow flex  py-2 text-xl hover:text-white hover:bg-gray-600 border  hover:border-0 rounded-xl"
        >
            ...
            ? foods.data.map((row) => (
                ...
                >
                  ...
                  <button
                    ...
                    className="p-2 border rounded-lg bg-orange-400 hover:text-white transition-all my-3"
                  >
                    Add
                  </button>
                </div>
